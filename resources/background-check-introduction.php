...
?>
    ...
    <div class="light-background">
        ...
        <h4><u>Introduction</u></h4><br>
        <p>The pre employment background is a step in the recruitment or onboarding process of every company created to validate the information provided during the interview steps and compare it to the specific requirements of the companies. </p><br><br>
        ...
        <p>The pre employment background check can either be 1) conducted by the Recruiters/HR representatives of the company or 2) endorsed to a third party background check company. The basis for almost all background checks conducted is a signed background investigation form that you accomplish once you pass the final interview or during your job offer.</p><br><br>
