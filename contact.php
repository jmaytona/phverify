...
?>
    ...
    <div class="privacyback">
        <div class="container">
            <p>For question, comments and suggestions, you may email us at phverify@yahoo.com.ph</p>
            <p>To report inaccurate entries, please use the report form below:</p>
        </div>
    </div>
    <br>
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-sm-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <p>For Questions, Concerns, Report on inaccurate data or help in updating of records, kindly fill out the text box on the right side and don't forget to inculde your active email address.</p>
                        </div>
                    </div>
                </div>
